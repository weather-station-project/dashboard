...
{
    private readonly WindMeasurements _m1 = new()
        {Speed = 10, Direction = "N", DateTime = new DateTime(2022, 01, 01, 5, 0, 0)};

    private readonly WindMeasurements _m2 = new()
        {Speed = 20, Direction = "E", DateTime = new DateTime(2022, 01, 01, 5, 30, 0)};

    private readonly WindMeasurements _m3 = new()
        {Speed = 30, Direction = "N", DateTime = new DateTime(2022, 01, 01, 5, 45, 0)};

    private readonly WindMeasurements _m4 = new()
        {Speed = 50, Direction = "O", DateTime = new DateTime(2023, 02, 15, 1, 15, 0)};

    private readonly WindMeasurements _m5 = new()
        {Speed = 60, Direction = "N", DateTime = new DateTime(2023, 02, 15, 1, 45, 0)};

    private readonly WindMeasurements _m6 = new()
        {Speed = 70, Direction = "N", DateTime = new DateTime(2023, 02, 15, 1, 55, 0)};
    ...
    {
        // Act
        var result = new HistoricalDataDto(new List<WindMeasurements> {_m1, _m2, _m3, _m4, _m5, _m6},
            GroupingValues.Hours,
            false, false);
        ...
        When_BuildingDto_Given_Measurements_And_GroupingHours_And_NoSummary_WithMeasurements_Should_Return_ExpectedData()
    {
        ...
        Assert.Equal(_m1.Speed, result.Measurements[0].Speed);
    }
            ...
            string keyGroup2, GroupingValues groupingValues)
    {
        ...
        Assert.Equal(new[] {"N"}, result.PredominantWindDirections.Keys);
        Assert.Equal(new[] {4}, result.PredominantWindDirections.Values);
